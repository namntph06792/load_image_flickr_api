package com.fox.demoassignment.adapter;
...
import com.fox.demoassignment.R;
...
//                mContext.startActivity(intent);
        ...
        String ratio = String.format("%d:%d",photo.getUrlO() != null ? photo.getWidthO() : photo.getWidthL(),photo.getUrlO() != null ? photo.getHeightO() : photo.getHeightL());
